...
const STARTER_DECKS: Deck[] = [
  ...
  {
    id: 'deck-starter-focus',
    user_id: 'local',
    name: '💡 Enfoque y Productividad',
    description: 'Domina el Trabajo Profundo, la técnica Pomodoro y bloquea distracciones.',
    color: '#10B981',
    is_ai_generated: false,
    created_at: new Date().toISOString(),
  },
  {
    id: 'deck-starter-learning',
    user_id: 'local',
    name: '🌱 Neurociencia del Aprendizaje',
    description: 'Aprende cómo consolidar memoria, plasticidad y optimizar tus hábitos.',
    color: '#F59E0B',
    is_ai_generated: false,
    created_at: new Date().toISOString(),
  }
...
const STARTER_CARDS: Record<string, Flashcard[]> = {
  ...
  'deck-starter-focus': [
    {
      id: 'card-f1',
      deck_id: 'deck-starter-focus',
      front: '¿Qué es el "Trabajo Profundo"?',
      back: 'Actividades profesionales realizadas en un estado de concentración libre de distracciones que llevan las capacidades cognitivas al límite.',
      hint: 'Cal Newport',
      interval: 0,
      repetitions: 0,
      ease_factor: 2.5,
    ...
    },
    {
      id: 'card-f2',
      deck_id: 'deck-starter-focus',
      front: '¿Qué es el "Residuo de Atención"?',
      back: 'La pérdida de rendimiento mental que ocurre cuando cambias rápidamente de una tarea a otra, dejando tu atención dividida.',
      hint: 'Efecto de la multitarea',
      interval: 0,
      repetitions: 0,
      ease_factor: 2.5,
      next_due: new Date().toISOString(),
    ...
    },
    {
      id: 'card-f3',
      deck_id: 'deck-starter-focus',
      front: '¿En qué consiste la técnica Pomodoro?',
      back: 'Dividir el tiempo de trabajo en bloques hiper-enfocados de 25 minutos separados por descansos de 5 minutos.',
      hint: 'Gestión del tiempo',
      interval: 0,
      repetitions: 0,
      ease_factor: 2.5,
      next_due: new Date().toISOString(),
  ...
  'deck-starter-learning': [
    {
      id: 'card-l1',
      deck_id: 'deck-starter-learning',
      front: '¿Qué es la Neuroplasticidad?',
      back: 'La capacidad biológica del cerebro de reconfigurar sus conexiones sinápticas y crear nuevas rutas en respuesta al aprendizaje.',
      hint: 'Moldeabilidad cerebral',
      interval: 0,
      repetitions: 0,
      ease_factor: 2.5,
      next_due: new Date().toISOString(),
    ...
    },
    {
      id: 'card-l2',
      deck_id: 'deck-starter-learning',
      front: '¿Cómo consolida el cerebro los aprendizajes?',
      back: 'Principalmente durante las fases de sueño profundo (ondas lentas), podando conexiones innecesarias y fortaleciendo las relevantes.',
      hint: 'Consolidación de memoria',
      interval: 0,
      repetitions: 0,
      ease_factor: 2.5,
      next_due: new Date().toISOString(),
    ...
    },
    {
      id: 'card-l3',
      deck_id: 'deck-starter-learning',
      front: '¿Qué es la Potenciación a Largo Plazo (LTP)?',
      back: 'El fortalecimiento persistente de las sinapsis debido a patrones repetidos de actividad, base molecular de la memoria.',
      hint: 'Mecanismo sináptico',
      interval: 0,
      repetitions: 0,
      ease_factor: 2.5,
      next_due: new Date().toISOString(),
