...
const ZONES: { title: string; subtitle: string; color: string; mascot: MascotKey; nodes: ZoneNode[] }[] = [
  {
    ...
    nodes: [
      ...
      { id: 'z1_schulte', kind: 'exercise', side: 'left',   label: 'Schulte 3×3',    color: COLORS.focus, exId: 'schulte', level: 1 },
      { id: 'z1_schulte2',kind: 'exercise', side: 'right',  label: 'Schulte 4×4',    color: COLORS.focus, exId: 'schulte', level: 2 },
      { id: 'z1_s2',      kind: 'exercise', side: 'left',   label: 'Lectura 200',    color: COLORS.swift, exId: 'reading', level: 1 },
      { id: 'z1_chest',   kind: 'chest',    side: 'center', label: 'Cofre',          color: '#EAB308' },
      { id: 'z1_schulte3',kind: 'exercise', side: 'right',  label: 'Schulte 5×5',    color: COLORS.focus, exId: 'schulte', level: 3 },
      { id: 'z1_focal',   kind: 'exercise', side: 'left',   label: 'Lectura Libre',  color: COLORS.joy,   exId: 'freereading', level: 1 },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'z2_ws1',    kind: 'exercise', side: 'left',   label: 'Word Span 4',   color: COLORS.calm,  exId: 'wordspan', level: 1 },
      { id: 'z2_ws1b',   kind: 'exercise', side: 'right',  label: 'Word Span 5',   color: COLORS.calm,  exId: 'wordspan', level: 2 },
      { id: 'z2_chest',  kind: 'chest',    side: 'center', label: 'Cofre',          color: '#EAB308' },
      { id: 'z2_ws2',    kind: 'exercise', side: 'left',   label: 'Word Span 6',   color: COLORS.calm,  exId: 'wordspan', level: 3 },
      { id: 'z2_ws3',    kind: 'exercise', side: 'right',  label: 'Word Span 7',   color: COLORS.calm,  exId: 'wordspan', level: 4 },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'z3_f1',     kind: 'exercise', side: 'left',   label: '400 WPM',        color: COLORS.swift, exId: 'reading', level: 4 },
      ...
      { id: 'z3_s6',     kind: 'exercise', side: 'right',  label: 'Schulte 6×6',    color: COLORS.focus, exId: 'schulte', level: 4 },
...
const NODE_DEPENDENCIES: Record<string, string[][]> = {
  z1_s1:       [],
  z1_schulte:  [['z1_s1']],
  z1_schulte2: [['z1_schulte']],
  z1_s2:       [['z1_schulte2']],
  z1_chest:    [['z1_s2']],
  z1_schulte3: [['z1_chest']],
  z1_focal:    [['z1_schulte3']],
  z1_comp:     [['z1_focal']],
  z1_comp2:    [['z1_comp']],
  z1_reading2: [['z1_comp2']],
  z1_boss:     [['z1_reading2']],
