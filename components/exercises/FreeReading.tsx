...
const styles = StyleSheet.create({
  ...
  passageTitle: { fontFamily: FONTS.heading, fontSize: 22, lineHeight: 28, letterSpacing: -0.5, color: COLORS.ink, marginTop: 4, textAlign: 'center' },
  ...
  qText: { fontFamily: FONTS.heading, fontSize: 19, letterSpacing: -0.2, color: COLORS.ink, lineHeight: 26 },
